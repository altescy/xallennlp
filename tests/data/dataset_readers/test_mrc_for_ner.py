...
class TestMrcForNerDatasetReader:
    def setup(self):
        ...
        self.query = ("geographical political entities are geographical regions defined by "
    ...
    def test_read(self):
        self.reader.read("data/mrc_ner.json")

    def test_text_to_instance(self):
        instance = self.reader.text_to_instance(self.context, self.query, self.metadata)
